...
-- 샘플 사용자 데이터 삽입 (비밀번호: password123)
...
('manager', 'manager@carcenter.com', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVEFDi', '매니저', '010-4567-8901', 'MANAGER', true);
